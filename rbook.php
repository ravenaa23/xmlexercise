...
<head>
    ...
    <title>CabWaala - Car Services</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                <li><a href="rindex.html">Home</a>                   
                                </li>
                               
                             
								
								<li><a href="rlogin.html">Log In</a></li>
                                <li><a href="rregister.html">Register</a></li> 
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Confirm Booking to proceed your ride!!</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
                ...
                <div class="col-lg-8 col-md-8 m-auto">
                	...
                	<div class="login-page-content">
                		<div class="login-form">
                			<h3>Welcome Back!</h3>
							<form action="rindex.html">
							    <table class="table table">
									
									<tbody>
									<tr>
										<td><b>Pick-up Location</b></td>
										<td><b>Anna Nagar</b></td>
										
									</tr>
									<tr>
										<td><b>Drop-up Location</b></td>
										<td><b>SS Colony</b></td>
										<
									</tr>
									<tr>
										<td><b> Nummber</b></td>
										<td><b>TN 65 2342</b></td>
								...
								<div class="log-btn">
									<button type="submit"><i class="fa fa-booking"></i>Confirm Booking</button>
								</div>
							</form>
                		</div>
