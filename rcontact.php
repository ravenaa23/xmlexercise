            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Contact yourself for the most popular cab service !!</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
                    ...
                    <div class="contact-form">
                        <form action="insertcomment.php">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="website-input">
                                        <input type="number_format" name="phone" placeholder="Number">
                                    </div>
                                </div>
                            ...
                            <div class="input-submit">
                                   <a href="index.php" class="book-now-btn" >Submit Message</a>
                            </div>
                        </form>
                    </div>
                </div>
